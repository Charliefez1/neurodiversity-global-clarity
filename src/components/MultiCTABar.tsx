  ...
  return (
    <section className={`${bgClass} py-12 lg:py-16`}>
      <div className="mx-auto max-w-wide px-6 lg:px-10">
        <div className={`grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-${visibleCTAs.length} gap-4`}>
          {visibleCTAs.map((cta) => {
            const inner = (
              <div
                className={`rounded-xl px-6 py-5 flex items-center gap-4 font-display font-bold text-sm transition-all duration-200 ${cta.style}`}
              >
